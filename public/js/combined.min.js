...
b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.6",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return c>e?"top":!1;if("bottom"==this.affixed)return null!=c?e+this.unpin<=f.top?!1:"bottom":a-d>=e+g?!1:"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&c>=e?"top":null!=d&&i+j>=a-d?"bottom":!1},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);$(function(){$(".phone-mask").mask("000-000-0000");$(window).on("load",function(){stickyFooter()});$(window).on("resize",function(){stickyFooter()});$("#contact_form").on("submit",function(){var data=$(this).serializeFormJSON();$(".form-group").removeClass("has-error");if(!data.full_name){$(".form-group--name").addClass("has-error");return false}if(!data.email||!isValidEmail(data.email)){$(".form-group--email").addClass("has-error");return false}if(!data.message){$(".form-group--message").addClass("has-error");return false}$(".error-message").addClass("hidden");$(".success-message").addClass("hidden");$(".submit-btn").addClass("disabled");$(".submit-btn").text("Submitting...");$.ajax({url:"/contact",method:"post",contentType:"application/json",data:JSON.stringify(data)}).success(function(){$(".submit-btn").removeClass("disabled");$(".submit-btn").text("Submit");$(".success-message").removeClass("hidden")}).error(function(response){$(".error-message").removeClass("hidden");$(".error-message").text(response.responseJSON.message);$(".submit-btn").removeClass("disabled");$(".submit-btn").text("Submit")});return false});$(".make-friendly-date").each(function(){var timestamp=$(this).data("timestamp");var friendly_date=friendlyDate(new Date(timestamp));$(this).html(friendly_date.day+", "+friendly_date.month+" "+friendly_date.date+" "+friendly_date.year)})});function stickyFooter(){var windowHeight=$(window).height();if(windowHeight>$("#footer").height()+$("#header").height()+$("#main").height()){$("#footer").addClass("sticky")}else{$("#footer").removeClass("sticky")}$("#footer").removeClass("invisible")}(function($){$.fn.serializeFormJSON=function(){var o={};var a=this.serializeArray();$.each(a,function(){if(o[this.name]){if(!o[this.name].push){o[this.name]=[o[this.name]]}o[this.name].push(this.value||"")}else{o[this.name]=this.value||""}});return o}})(jQuery);function isValidEmail(email){var re=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return re.test(email)}function friendlyDate(a){var months=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];var days=["Sun","Mon","Tues","Wed","Thurs","Fri","Sat"];var year=a.getFullYear();var month=months[a.getMonth()];var day=days[a.getDay()];var date=a.getDate();var hour=a.getHours();var min=a.getMinutes();var sec=a.getSeconds();var time={day:day,date:date,month:month,year:year,hour:hour,min:min,sec:sec};return time}function openPhotoSwipe(images){var pswpElement=document.querySelectorAll(".pswp")[0];var items=[];images.forEach(function(item){if(item)items.push({html:'<div style="background-image: url('+item+'?w=3000); background-repeat: no-repeat; background-position: center; background-size: contain; width: 100%; height: 100%;"></div>'})});var options={history:false,focus:false,showAnimationDuration:0,hideAnimationDuration:0};var gallery=new PhotoSwipe(pswpElement,PhotoSwipeUI_Default,items,options);gallery.init()}$(function(){$(".open-photoswipe").on("click",function(){var images=$(this).data("images").split(",");openPhotoSwipe(images)})});